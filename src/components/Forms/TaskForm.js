...
const massUpdateCapableFieldKeys = [{ label: 'Complete', value: 'Complete' }];
...
const TaskForm = ({
	...
	useEffect(() => {
		console.log(`TaskForm.js state change`, state);
						...
						<GridFormSectionWrapper>
							...
							<GridInputWrapper
								...
								<AsynchronousSelect2
									...
									defaultValue={state.currentData.Type}
									onChange={(e) => mountData('Type', e)}
									required
								/>
							</GridInputWrapper>
							<GridInputWrapper />
							<GridInputWrapper
								massUpdating={massUpdating}
								hidden={massUpdating && !massUpdateFieldList.includes('Start')}>
								<TextFieldDateTime
									type='dateTime'
									label='Start'
									value={state.currentData.Start}
									onChange={(e) => mountData('Start', e)}
									required
									error={error.Start}
									helperText={
										error.Start
							...
							<GridInputWrapper
								massUpdating={massUpdating}
								hidden={massUpdating && !massUpdateFieldList.includes('End')}>
								<TextFieldDateTime
									type='dateTime'
									label='End'
									value={state.currentData.End}
									onChange={(e) => mountData('End', e)}
									required
									error={error.End}
									helperText={
										error.End
							...
							<GridInputWrapper
								...
								<RichTextField
									label='Description'
									defaultValue={state.currentData.Description}
									onChange={(e) => mountData('Description', e)}
								/>
							</GridInputWrapper>
							<GridInputWrapper />
							{/* Sections */}
