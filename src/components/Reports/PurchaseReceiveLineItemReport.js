...
export const columns = [
	{
		field: 'Purchase_Receive.Purchase_Order',
		headerName: 'Purchase Order',
		flex: 1,
	},
	// {
	// 	field: 'Purchase_Receive',
	// 	headerName: 'Purchase Receive',
	// 	flex: 1,
	...
	{
		field: 'Serial_Number_Entry',
		headerName: 'Serial Numbers',
		flex: 4,
		valueGetter: ({ value }) => (value ? JSON.parse(value).join(', ') : ''),
	},
];
...
const PurchaseReceiveLineItemReport = ({
	maxHeight,
	showActions,
	forcedCriteria,
	loadData,
...
PurchaseReceiveLineItemReport.propTypes = {
...
export default PurchaseReceiveLineItemReport;
