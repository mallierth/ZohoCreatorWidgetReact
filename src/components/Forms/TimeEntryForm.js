...
const TimeEntryForm = ({
	...
	useEffect(() => {
		console.log(`TimeEntryForm.js state change`, state);
					...
					<ThemeCard>
						<GridFormSectionWrapper>
							...
							<GridInputWrapper
								massUpdating={massUpdating}
								hidden={
									massUpdating && !massUpdateFieldList.includes('Reason')
								}>
								<AsynchronousSelect2
									label='Reason'
									name='Reason'
									...
									defaultValue={state.currentData.Reason}
									onChange={(e) => mountData('Reason', e)}
									required
								/>
							</GridInputWrapper>
							<GridInputWrapper
							...
							<GridInputWrapper
								massUpdating={massUpdating}
								hidden={
									massUpdating && !massUpdateFieldList.includes('Start_Time')
								}>
								<TextFieldDateTime
									type='time'
									label='Start Time'
									value={state.currentData.Start_Time}
									onChange={(e) => mountData('Start_Time', e)}
									required
							...
							<GridInputWrapper
								massUpdating={massUpdating}
								hidden={
									massUpdating && !massUpdateFieldList.includes('End_Time')
								}>
								<TextFieldDateTime
									type='time'
									label='End Time'
									value={state.currentData.End_Time}
									onChange={(e) => mountData('End_Time', e)}
									required
							...
							<GridInputWrapper
								...
								hidden={
									massUpdating &&
									!massUpdateFieldList.includes('Work_Performed')
								}>
								<TextField
									label='Work Performed'
									value={state.currentData.Work_Performed}
									multiline
									onChange={(e) => mountData('Work_Performed', e.target.value)}
								/>
							</GridInputWrapper>
							{/* Sections */}
							{/* <GridInputWrapper>
